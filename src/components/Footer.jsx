            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="text-gray-300">
                        <div className="text-2xl font-bold text-white mb-4">BrightSmile</div>
                        <p className="text-sm leading-relaxed mb-6 text-gray-400">
                            Providing compassionate, high-quality dental care with modern technology. Your smile is our priority.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            ...
                            <li><a href="#doctors" className="text-gray-400 hover:text-white transition-colors text-sm">Meet the Team</a></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li><a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">General Checkup</a></li>
                            <li><a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">Teeth Whitening</a></li>
                            <li><a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">Dental Implants</a></li>
                            <li><a href="#" className="text-gray-400 hover:text-white transition-colors text-sm">Orthodontics</a></li>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li className="text-gray-400 text-sm">123 Health Avenue, Suite 400<br />New York, NY 10001</li>
                            <li className="text-gray-400 text-sm">Phone: (555) 123-4567</li>
                            <li className="text-gray-400 text-sm">Email: info@brightsmile.com</li>
                        </ul>
                    </div>
                </div>
